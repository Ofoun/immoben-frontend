...
public class PayPalService {
	...
	private void throwExceptionForNonOKResponse(HttpStatus statusCode) throws PayPalApiException {
		...
		switch (statusCode) {
		case NOT_FOUND: 
			message = "L'identifiant de commande introuvable";
			
		case BAD_REQUEST:
			message = "Mauvaise demande à l'API de paiement PayPal";
			
		case INTERNAL_SERVER_ERROR:
			message = "Erreur du serveur PayPal";
			
		default:
			message = "PayPal a renvoyé un code de statut non OK"
					+ "";
		}
