...
public class AddressController {
	...
	public String newAddress(Model model) {
		...
		model.addAttribute("pageTitle", "Ajouter une nouvelle adresse");
	...
	public String saveAddress(Address address, HttpServletRequest request, RedirectAttributes ra) {
		...
		ra.addFlashAttribute("message", "L'adresse de " + address.getFirstName() + " " + address.getLastName() + " a été enregistrée avec succès.");
	...
	public String deleteAddress(@PathVariable("id") Integer addressId, RedirectAttributes ra,
		...
		ra.addFlashAttribute("message", "L'adresse avec ID " + addressId + " a été supprimée avec succès.");
