...
//		customer.getCountry().setName("Benin");
	...
	public void addNewCustomerUponOAuthLogin(String name, String email, Integer id, String countryCode, 
		...
		customer.setCity(cityRepo.findById(id).get());
		customer.setState(stateRepo.findById(id).get());
		customer.setPhoneNumber("");
		customer.setPostalCode("");
		customer.setCountry(countryRepo.findById(id).get());
